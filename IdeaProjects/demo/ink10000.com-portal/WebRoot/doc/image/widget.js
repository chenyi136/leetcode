var _widgets={
	style:{
		...
		badge:{depStyle:[]},
		breadcrumb:{depStyle:[]},
		"button-group":{depStyle:["button.less"]},
		close:{depStyle:[]},
		comment:{depStyle:[]},
		icon:{depStyle:[]},
		"input-group":{depStyle:["form.less","button.less"]},
		list:{depStyle:[]},
		nav:{depStyle:[]},
		pagination:{depStyle:[]},
		panel:{depStyle:[]},
	...
	js:{
		core:{depStyle:[],depJs:[]},
		"ui.add2home":{depStyle:["ui.add2home.less"],depJs:[]},
		"ui.alert":{depStyle:["ui.alert.less","close.less","ui.component.less"],depJs:[]},
		"ui.button":{depStyle:["button.less","button-group.less","icon.less"],depJs:[]},
		"ui.collapse":{depStyle:["ui.component.less"],depJs:[]},
		"ui.dimmer":{depStyle:["ui.component.less"],depJs:[]},
		"ui.dropdown":{depStyle:["ui.dropdown.less","animation.less"],depJs:[]},
		"ui.flexslider":{depStyle:["ui.flexslider.less","icon.less"],depJs:[]},
		"ui.iscroll-lite":{depStyle:[],depJs:[]},
		"ui.modal":{depStyle:["ui.modal.less","ui.component.less","close.less"],depJs:["ui.dimmer.js"]},
		"ui.offcanvas":{depStyle:["ui.offcanvas.less"],depJs:[]},
		"ui.pinchzoom":{depStyle:[],depJs:[]},
		"ui.popover":{depStyle:["ui.popover.less"],depJs:[]},
		"ui.progress":{depStyle:["ui.progress.less"],depJs:[]},
		"ui.pureview":{depStyle:["ui.pureview.less","icon.less"],depJs:["ui.pinchzoom.js","util.hammer.js"]},
		"ui.scrollspy":{depStyle:["animation.less"],depJs:[]},
		"ui.scrollspynav":{depStyle:[],depJs:["ui.smooth-scroll.js"]},
		"ui.share":{depStyle:["ui.share.less","icon.less","button.less"],depJs:["util.qrcode.js","ui.modal.js"]},
		"ui.smooth-scroll":{depStyle:[],depJs:[]},
		"ui.sticky":{depStyle:["ui.component.less","animation.less"],depJs:[]},
		"ui.tabs":{depStyle:["nav.less","ui.tabs.less"],depJs:["util.hammer.js"]},
		"ui.datepicker":{depStyle:["form.less","icon.less","input-group.less","ui.datepicker.less"],depJs:[]},
		"ui.selected":{depStyle:["utility.less","button.less","icon.less","form.less","ui.dropdown.less","ui.selected.less"],depJs:["ui.dropdown.js"]},
		"ui.ucheck":{depStyle:["icon.less","ui.ucheck.less"],depJs:[]},
		"ui.validator":{depStyle:["form.less"],depJs:[]},
		"util.cookie":{depStyle:[],depJs:[]},
		"util.fullscreen":{depStyle:[],depJs:[]},
		"util.geolocation":{depStyle:[],depJs:[]},
		"util.hammer":{depStyle:[],depJs:[]},
		"util.qrcode":{depStyle:[],depJs:[]},
		"util.store":{depStyle:[],depJs:[]}
	},
	widgets:{
		accordion:{
			id:"accordion",
			name:"Accordion",
			localName:{en:"Accordion","zh-cn":"折叠面板"},
			version:"2.1.0",
			description:"类似手风琴的内容折叠模块",
			author:{name:"Minwe",email:"minwe@yunshipei.com"},
			ver:"2.1",
			icon:"accordion.png",
			...
			options:{
				multiple:{
					...
					required:!1,
					dataList:[
						{value:"false",title:"不启用",selected:!0},
						{value:!0,title:"启用"}
					]
				}
			},
					...
					variables:[
						{
							...
							used:[{selector:".am-accordion-item",property:"border-top-color"}]
						},
						{
							variable:"accordion-title-color",
							name:"标题颜色",
							"default":"rgba(0,0,0,0.6)",
							used:[{selector:".am-accordion-title",property:"color"}]
						},
						{
							...
							"default":"#428BCA",
							used:[
								{selector:".am-accordion-title:hover",property:"color"},
								{selector:".am-active .am-accordion-title",property:"color"}
							]
						},
						{
							...
							name:"标题激活背景颜色",
							"default":"#EEE",
							used:[{selector:".am-active .am-accordion-title",property:"background-color"}]
						},
						{
							variable:"accordion-content-color",
							name:"内容颜色",
							"default":"#666",
							used:[{selector:".am-accordion-content",property:"color"}]
						}
					],
					demos:[
						{
					...
					variables:[
						{
							...
							used:[{selector:".am-accordion-item",property:"border-color"}]
						},
						{
							variable:"accordion-title-color",
							name:"标题颜色",
				...
				},
				{
					...
					variables:[
						...
						},
						{
							...
							name:"标题激活颜色",
							"default":"#15AFEF",
							used:[{selector:".am-active .am-accordion-title",property:"color"}]
						},
						{
							variable:"accordion-title-active-color",
							name:"标题激活背景色",
		...
		divider:{
			id:"divider",
			name:"Divider",
			localName:{en:"Divider","zh-cn":"分割线"},
			version:"2.0.1",
			description:"分割线",
			author:{name:"Shengli",email:"china_victory@yunshipei.com"},
			ver:"2.0",
			icon:"divider.png",
					...
					variables:[
						{
							...
							name:"分割线颜色",
							"default":"#DDD",
							used:[{selector:"",property:"background-color"}]
						}
					],
					demos:[{desc:"",data:{}}]
				},
			...
			themes:[
				{
					...
					variables:[],
					demos:[{desc:"",data:{options:{shortName:"amazeui"}}}]
				}
			]
		},
		figure:{
			id:"figure",
			name:"Figure",
			localName:{en:"Figure","zh-cn":"单张图片"},
			version:"2.0.3",
			description:"显示单张图片",
			author:{name:"Minwe",email:"minwe@yunshipei.com"},
			ver:"2.0",
			...
			options:{
				figcaptionPosition:{
					...
					required:!0,
					dataList:[
						{value:"bottom",title:"图片下方",selected:!0},
						{value:"top",title:"图片上方"}
					]
				},
				zoomAble:{
					name:"图片缩放",
					...
					required:!0,
					dataList:[
						{value:"auto",title:"自动判断",selected:!0},
						{value:!0,title:"强制启用",selected:!0},
						{value:!1,title:"强制禁用"}
					]
				}
			},
			themes:[
				{
					name:"default",
					desc:"灰色边框",
					options:{figcaptionPosition:"bottom",zoomble:!1},
					...
					variables:[
						{
							...
							name:"图片边框颜色",
							"default":"#DEDEDE",
							used:[{selector:"img",property:"border-color"}]
						},
						{
							variable:"figure-color",
							name:"文字颜色",
							"default":"#333",
							used:[{selector:"figcaption",property:"color"}]
						}
					],
					demos:[{desc:"",data:{options:{figcaptionPosition:"bottom",zoomAble:!0}}}]
				},
				{
					name:"one",
					desc:"简约风格",
					...
					demos:[{desc:"",data:{options:{figcaptionPosition:"bottom",zoomAble:"auto"}}}]
				}
			],
			demoContent:{
			...
			themes:[
				{
					...
					variables:[
						...
						},
						{
							...
							name:"云适配版文字颜色",
							"default":"#555",
							used:[{selector:".am-footer-ysp",property:"color"}]
						},
						{
							variable:"footer-divider-color",
							name:"分隔线颜色",
							"default":"#CCC",
							used:[{selector:".am-footer-divider",property:"color"}]
						},
						{
							variable:"footer-desktop-color",
							name:"电脑版颜色",
							"default":"#CCC",
							used:[{selector:".am-footer-desktop",property:"color"}]
						},
						{
							variable:"footer-link-color",
							name:"链接颜色",
							"default":"#555",
							used:[{selector:"a",property:"color"}]
						},
						{
							variable:"footer-miscs-color",
							name:"版权信息颜色",
							"default":"#999",
							used:[{selector:".am-footer-miscs",property:"color"}]
						}
					],
					demos:[
						{
				...
				},
				{
					...
					variables:[
						...
						},
						{
							...
							name:"版权信息链接颜色",
							"default":"#555",
							used:[{selector:".am-footer-miscs a",property:"color"}]
						}
					],
					demos:[
						{
		...
		gallery:{
			id:"gallery",
			name:"Gallery",
			localName:{en:"Gallery","zh-cn":"图片画廊"},
			version:"3.0.0",
					...
					variables:[
						{
							...
							name:"标题颜色",
							"default":"#555",
							used:[{selector:".am-gallery-title",property:"color"}]
						},
						{
							variable:"gallery-desc-color",
							name:"描述信息颜色",
							"default":"#999",
							used:[{selector:".am-gallery-desc",property:"color"}]
						}
					],
					demos:[
						{
							desc:"2列",
							data:{options:{cols:2,gallery:!0}}
						},
						{
							desc:"3列",
							data:{options:{cols:3,gallery:!0}}
						}
					]
				},
				{
					...
					variables:[
						...
						},
						{
							...
							used:[{selector:".am-gallery-title",property:"background-color"}]
						}
					],	
					demos:[{desc:"",data:{options:{cols:2,gallery:!0}}}]
				},
				{
					name:"bordered",
					desc:"容器边框",
					...
					demos:[{desc:"",data:{options:{cols:2}}}]
				},
				{
					name:"imgbordered",
					desc:"图片边框",
				...
				},
				{
					...
					variables:[
						...
						},
						{
							...
							name:"更多背景",
							"default":"#DFDFDF",
							used:[{selector:".am-gallery-more a",property:"background-color"}]
						},
						{
							variable:"gallery-more-link-color",
							name:"更多文字颜色",
							"default":"#555",
							used:[{selector:".am-gallery-more a",property:"color"}]
						}
					],
					demos:[{desc:"",data:{options:{cols:2,gallery:!0}}}]
				}
			...
			demoContent:[
				{
					img:"assets/i/bing-1.jpg",
					link:"assets/i/bing-1.jpg",
					title:"远方 有一个地方 那里种有我们的梦想",
					desc:"2375-09-26"
				},
				{
					img:"assets/i/bing-2.jpg",
					link:"assets/i/bing-2.jpg",
					title:"某天 也许会相遇 相遇在这个好地方",
					desc:"2375-09-26"
				},
				{
					img:"assets/i/bing-3.jpg",
					link:"assets/i/bing-3.jpg",
					title:"不要太担心 只因为我相信",
					desc:"2375-09-26"
				},
				{
					img:"assets/i/bing-4.jpg",
					link:"assets/i/bing-4.jpg",
					title:"终会走过这条遥远的道路",
					desc:"2375-09-26"
				}
			]
			...
			themes:[
				{
					...
					variables:[
						{
							...
							name:"背景颜色",
							"default":"#428BCA",
							used:[{selector:"a",property:"background-color"}]
						},
						{
					...
					demos:[{desc:"",data:{content:{title:"回到顶部"}}}]
				},
				{
					name:"fixed",
					desc:"右侧悬浮",
					...
					variables:[
						{
							...
							name:"图标背景色",
							"default":"#555",
							used:[{selector:".am-gotop-icon",property:"background-color"}]
						},
						{
							variable:"gotop-icon-color",
							name:"图标颜色",
							"default":"#DDD",
							used:[{selector:".am-gotop-icon",property:"color"}]
						},
						{
							variable:"gotop-icon-hover-color",
							name:"图标 Hover 颜色",
							"default":"#FFF",
							used:[{selector:".am-gotop-icon:hover",property:"color"}]
						}
					],
					demos:[
						{
							desc:"默认 Icon",
							data:{content:{title:"回到顶部"}}
						},
						{
							desc:"设置 Icon",
							data:{content:{icon:"hand-o-up"}}
						},
						{
							desc:"自定义图片",
							data:{content:{customIcon:"http://amazeui.b0.upaiyun.com/assets/i/cpts/gotop/goTop.gif"}}
						}
					]
				},
				{
					...
					variables:[
						...
						},
						{
							...
							name:"边框颜色",
							"default":"#15AFEF",
							used:[{selector:"",property:"border-color"}]
						},
						{
							variable:"gotop-icon-color",
							name:"图标",
		...
		header:{
			id:"header",
			name:"Header",
			localName:{en:"Header","zh-cn":"页头"},
			version:"2.0.0",
			description:"页面顶部",
			author:{name:"hzp",email:"hzp@yunshipei.com"},
			ver:"2.0",
			icon:"header.png",
			...
			themes:[
				{
					...
					variables:[
						...
						},
						{
							...
							name:"标题颜色",
							"default":"#FFF",
							used:[{selector:".am-header-title,.am-header-title a",property:"color"}]
						},
						{
							variable:"header-nav-color",
							name:"两侧图标文字颜色",
							"default":"#FFF",
							used:[{selector:".am-header-nav a",property:"color"}]
						}
					],
					demos:[
						{
							...
							data:{
								content:{
									left:[{link:"#left-link",icon:"home"}],
									title:"Amaze UI",
									link:"#title-link",
									right:[{link:"#right-link",icon:"bars"}]
								}
							}
						},
						{
						...
						},
						{
							...
							data:{
								content:{
									left:[{link:"#left-link",title:"首页",icon:"home"}],
									title:"Amaze UI",
									right:[{link:"#right-link",icon:"bars",title:"菜单"}]
								}
							}
						},
						{
							...
							data:{
								content:{
									left:[
										{link:"#left-link",icon:"home"},
										{link:"#phone-link",icon:"phone"}
									],
									title:"Amaze UI",
									right:[
										{link:"#user-link",icon:"user"},
										{link:"#cart-link",icon:"shopping-cart"}
									]
								}
							}
						},
						{
							...
							data:{
								content:{
									...
									right:[
										{link:"#user-link",icon:"user"},
										{link:"#cart-link",className:"am-btn am-btn-secondary",icon:"shopping-cart"}
									]
								}
							}
						}
			...
			themes:[
				{
					name:"default",
					desc:"默认",
					options:{leftCols:"5",rightCols:"7",position:"top"},
					...
					variables:[
						{
							...
							name:"标题背景色",
							"default":"#0E90D2",
							used:[{selector:".am-intro-hd",property:"background-color"}]
						},
						{
							variable:"intro-hd-color",
							name:"标题文本颜色",
							"default":"#FFF",
							used:[{selector:".am-intro-title",property:"color"}]
						},
						{
							variable:"intro-hd-link-color",
							name:"More链接颜色",
							"default":"#EEE",
							used:[{selector:".am-intro-hd a",property:"color"}]
						}
					],
					demos:[
						{
							desc:"More 在上",
							data:{options:{leftCols:5,rightCols:7,position:"top"}}
						},
						{
							desc:"More 在下",
							data:{options:{leftCols:5,rightCols:7,position:"bottom"}}
						}
					]
				},
				{
					name:"one",
					desc:"简约风格",
					options:{leftCols:"5",rightCols:"7",position:"bottom"},
					...
					variables:[
						...
						},
						{
							...
							"default":"#15AFEF",
							used:[
								{selector:".am-intro-hd",property:"border-bottom-color"},
								{selector:".am-intro-title:before",property:"background-color"}
							]
						},
						{
							...
							name:"内容颜色",
							"default":"#555",
							used:[{selector:".am-intro-bd",property:"color"}]
						}
					],
					demos:[{desc:"",data:{options:{leftCols:5,rightCols:7,position:"top"}}}]
				}
			],
			demoContent:{
				title:"你好小娜",
				more:{link:"#more",title:"更多细节"},
		...
		list_news:{
			id:"list_news",
			name:"List",
			localName:{en:"List","zh-cn":"内容列表"},
			version:"4.0.0",
			description:"内容列表模块",
			author:{name:"Minwe Luo",email:"minwe@yunshipei.com"},
			ver:"4.0",
			icon:"list_news.png",
			...
			options:{
				type:{
					...
					"default":"normal",
					dataList:[
						{value:"normal",title:"文字列表"},
						{value:"thumb",title:"带缩略图列表"}
					]
				},
				thumbPosition:{
					name:"缩略图位置",
					...
					variables:[
						{
							...
							name:"边框颜色",
							"default":"#DEDEDE",
							used:[{selector:".am-list>li",property:"border-color"}]
						},
						{
							variable:"list-date-color",
							name:"日期颜色",
							"default":"#999",
							used:[{selector:".am-list-date",property:"color"}]
						},
						{
							variable:"list-text-color",
							name:"摘要颜色",
							"default":"rgb(153,153,153)",
							used:[{selector:".am-list .am-list-item-text",property:"color"}]
						}
					],
					demos:[
						{
							...
							data:{
								content:{
									...
									main:[
										{title:"我很囧，你保重....晒晒旅行中的那些囧！",link:"#",date:"2013-09-18"},
										{title:"我最喜欢的一张画",link:"#",date:"2013-10-14"},
										{title:"“你的旅行，是什么颜色？” 晒照片，换北欧梦幻极光之旅！",link:"#",date:"2013-11-18"}
									]
								}
							}
						},
						{
							...
							data:{
								content:{
									...
									main:[
										{title:"我很囧，你保重....晒晒旅行中的那些囧！",link:"http://www.douban.com/online/11614662/"},
										{title:"我最喜欢的一张画",link:"http://www.douban.com/online/11624755/"},
										{title:"“你的旅行，是什么颜色？” 晒照片，换北欧梦幻极光之旅！",link:"http://www.douban.com/online/11645411/"}
									]
								}
							}
						},
						...
						},
						{
							desc:"上图+摘要",
							data:{
								options:{type:"thumb",thumbPosition:"top"},
								content:{
									header:{
										title:"缩略图在上方 + 摘要",
										link:"#",
						...
						},
						{
							desc:"左图+摘要",
							data:{
								options:{type:"thumb",thumbPosition:"left"},
								content:{
									header:{
										title:"左图 + 摘要",
										link:"#",
						...
						},
						{
							desc:"右图+摘要",
							data:{
								options:{type:"thumb",thumbPosition:"right"},
								content:{
									header:{
										title:"缩略图在标题右边 + 摘要",
										link:"#",
						...
						},
						{
							desc:"下图+摘要",
							data:{
								options:{type:"thumb",thumbPosition:"bottom-left"},
								content:{
									header:{
										title:"缩略图在标题下左 + 摘要",
										link:"#",
						...
						},
						{
							...
							data:{
								theme:"default",
								options:{type:"thumb",thumbPosition:"bottom-right"},
								content:{
									header:{
										title:"缩略图在标题下右 + 摘要",
										link:"#",
					...
					variables:[
						{
							...
							"default":"#000",
							used:[
								{selector:".am-list-news-hd>a",property:"color"},
								{selector:".am-list .am-list-item-desced a.am-list-item-hd",property:"color"}
							]
						},
						{
							...
							"default":"#15AFEF",
							used:[
								{selector:".am-list-news-hd",property:"border-bottom-color"},
								{selector:".am-list-news-hd::before",property:"background-color"}
							]
						},
						{
							...
							"default":"#222",
							used:[
								{selector:".am-list .am-list-item-dated>a",property:"color"},
								{selector:".am-list-item-hd>a",property:"color"},
								{selector:".am-list .am-list-item-thumbed .am-list-item-hd a",property:"color"}
							]
						},
						{
							...
							"default":"#666",
							used:[
								{selector:".am-list .am-list-item-desced .am-list-item-text",property:"color"},
								{selector:".am-list .am-list-item-text>a",property:"color"},
								{selector:".am-list .am-list-item-thumbed .am-list-main .am-list-item-text",property:"color"}
							]
						}
					],
					demos:[
		...
		mechat:{
			id:"mechat",
			name:"Mechat",
			localName:{en:"Mechat","zh-cn":"美洽客服"},
			version:"2.0.1",
			description:"美洽在线客服平台",
			author:{name:"cg",email:"trustmore@163.com"},
			ver:"2.0",
			icon:"mechat.png",
			...
			themes:[
				{
					...
					demos:[{desc:"",data:{options:{unitid:"2538"}}}]
				}
			]
		},
		menu:{
					...
					variables:[
						{
							...
							name:"背景颜色",
							"default":"#FFF",
							used:[{selector:".am-menu-nav",property:"background-color"}]
						},
						{
							variable:"menu-nav-link-color",
							name:"链接颜色",
							"default":"#0E90D2",
							used:[{selector:".am-menu-nav a",property:"color"}]
						},
						{
							variable:"menu-nav-top-active-color",
							name:"一级菜单激活颜色",
							"default":"#095F8A",
							used:[{selector:".am-menu-nav>.am-parent.am-open>a",property:"color"}]
						},
						{
							...
							"default":"#F1F1F1",
							used:[
								{selector:".am-menu-sub",property:"background-color"},
								{selector:".am-menu-nav>.am-parent>a:before",property:"color"}
							]
						},
						{
							...
							name:"二级菜单链接颜色",
							"default":"#555",
							used:[{selector:".am-menu-sub >li>a",property:"color"}]
						}
					],
					demos:[{desc:"横排",data:{options:{cols:"3"}}}]
				},
				{
					name:"dropdown1",
					desc:"下拉全宽",
					...
					variables:[
						{
							...
							name:"触发按钮颜色",
							"default":"#C7C7C7",
							used:[{selector:".am-menu-toggle",property:"color"}]
						},
						{
							variable:"menu-nav-top-link-color",
							name:"一级菜单颜色",
							"default":"#FFF",
							used:[{selector:".am-menu-nav>li>a",property:"color"}]
						},
						{
							variable:"menu-nav-top-link-bg",
							name:"一级菜单背景色",
							"default":"#0E90D2",
							used:[{selector:".am-menu-nav>li>a",property:"background-color"}]
						},
						{
							variable:"menu-nav-border-color",
							name:"边框颜色",
							"default":"#4C5565",
							used:[{selector:".am-menu-nav>li>a",property:"border-bottom-color"}]
						},
						{
							variable:"menu-nav-top-link-active-color",
							name:"一级菜单激活颜色",
							"default":"#6B717D",
							used:[{selector:".am-menu-nav>li.am-parent.am-open>a",property:"color"}]
						},
						{
							...
							"default":"#C5C9D2",
							used:[
								{selector:".am-menu-nav>li.am-parent.am-open>a",property:"background-color"},
								{selector:".am-menu-nav>li.am-parent.am-open>a::after",property:"border-top-color"}
							]
						},
						{
							variable:"menu-nav-sub-link-color",
				...
				},
				{
					...
					variables:[
						...
						},
						{
							...
							name:"一级菜单激活颜色",
							"default":"#6B717D",
							used:[{selector:".am-menu-nav>li.am-parent.am-open>a:after",property:"color"}]
						},
						{
							variable:"menu-nav-sub-link-color",
							name:"二级菜单颜色",
						...
						},
						{
							...
							used:[
								{selector:".am-menu-sub",property:"background-color"},
								{selector:".am-menu-nav>li.am-parent.am-open>a:before",property:"color"}
							]
						}
					],
					demos:[{desc:"",data:{options:{cols:"4"}}}]
				},
				{
					name:"slide1",
					desc:"指示箭头一级下滑1",
					...
					variables:[
						...
						},
						{
							...
							"default":"#F5F5F5",
							used:[
								{selector:".am-menu-nav",property:"background-color"},
								{selector:".am-menu-nav.am-in:before",property:"color"}
							]
						},
						{
							variable:"menu-nav-link-color",
				...
				},
				{
					...
					variables:[
						...
						},
						{
							...
							name:"一级菜单 Hover 颜色",
							"default":"#FFF",
							used:[{selector:".am-menu-nav>.am-open>a,.am-menu-nav>li>a:hover,.am-menu-nav>li>a:focus",property:"color"}]
						},
						{
							variable:"menu-nav-top-link-hover-bg",
							name:"一级菜单 Hover 背景色",
							"default":"#404040",
							used:[{selector:".am-menu-nav>.am-open>a,.am-menu-nav>li>a:hover,.am-menu-nav>li>a:focus",property:"background-color"}]
						},
						{
							variable:"menu-nav-top-link-active-bg",
							name:"二级菜单背景色",
						...
						},
						{
							...
							name:"二级菜单 Hover 颜色",
							"default":"#FFF",
							used:[{selector:".am-menu-sub a:hover",property:"color"}]
						}
					],
					demos:[
						{
						...
						{
							desc:"侧滑右侧",
							data:{options:{cols:"1",offCanvasFlip:!0}}
						}
					]
				},
				{
					name:"offcanvas2",
					desc:"侧滑横排",
					options:{cols:"3",offCanvasFlip:!0},
					...
					variables:[
						...
						},
						{
							...
							name:"链接 Hover 颜色",
							"default":"#FFF",
							used:[{selector:".am-menu-nav>li>a:hover,.am-menu-nav>li>a:focus",property:"color"}]
						},
						{
							variable:"menu-nav-link-active-color",
							name:"链接激活颜色",
							"default":"#FFF",
							used:[{selector:".am-menu-nav>.am-active>a",property:"color"}]
						},
						{
							...
							"default":"#262626",
							used:[
								{selector:".am-menu-nav>li>a:hover,.am-menu-nav>li>a:focus",property:"background-color"},
								{selector:".am-menu-nav>.am-active>a",property:"background-color"}
							]
						},
						{
							variable:"menu-nav-border-color",
							...
							used:[{selector:".am-menu-nav>li>a",property:"border-color"}]
						}
					],
					demos:[
						{
				...
				},
				{
					...
					variables:[
						...
						},
						{
							...
							"default":"#DEDEDE",
							used:[
								{selector:".am-menu-nav",property:"border-bottom-color"},
								{selector:"&>li.am-parent.am-open>a",property:"border-bottom-color"},
								{selector:".am-menu-sub,.am-menu-nav>li>a",property:"border-top-color"}
							]
						}
					],
					demos:[{desc:"",data:{options:{cols:"1"}}}]
				},
				{
					name:"one",
					desc:"简约风格",
					...
					variables:[
						...
						},
						{
							...
							"default":"#15AFEF",
							used:[
								{selector:".am-menu-nav .am-active>a",property:"border-bottom-color"},
								{selector:".am-menu-nav .am-open>a::before",property:"border-bottom-color"}
							]
						},
						{
							variable:"menu-nav-sub-bg",
		...
		navbar:{
					...
					variables:[
						{
							...
							name:"背景颜色",
							"default":"#0E90D2",
							used:[{selector:".am-navbar-nav",property:"background-color"}]
						},
						{
						...
						},
						{
							...
							name:"更多列表背景",
							"default":"#0D86C4",
							used:[{selector:".am-navbar-actions",property:"background-color"}]
						},
						{
							variable:"navbar-actions-border-bottom",
							name:"更多列表下边框颜色",
							"default":"#FFF",
							used:[{selector:".am-navbar-actions a",property:"border-color"}]
						}
					],
					demos:[
						{desc:"字体图标",data:{options:{cols:"4"}}},
						{
							desc:"自定义图标",
							data:{
								options:{cols:"4"},
			...
			demoContent:[
				{title:"呼叫",link:"tel:123456789",icon:"phone"},
				{title:"分享",link:"#",icon:"share-square-o",dataApi:"data-am-navbar-share"},
				{title:"二维码",link:"#",icon:"qrcode",dataApi:"data-am-navbar-qrcode"},
				{title:"GitHub",link:"https://github.com/allmobilize/amazeui",icon:"github"},
				{title:"下载使用",link:"http://amazeui.org/getting-started",icon:"download"},
				{title:"Bug 反馈",link:"https://github.com/allmobilize/amazeui/issues",icon:"location-arrow"}
			]
		},
		pagination:{
			id:"pagination",
			name:"Pagination",
			localName:{en:"Pagination","zh-cn":"分页"},
			version:"3.0.1",
			description:"分页组件",
			author:{name:"Shengli",email:"china_victory@yunshipei.com"},
			ver:"3.0",
					...
					variables:[
						{
							...
							name:"页码背景色",
							"default":"#EEE",
							used:[{selector:"li a",property:"background-color"}]
						},
						{
							variable:"pagination-link-color",
							name:"页码颜色",
							"default":"#222",
							used:[{selector:"li a",property:"color"}]
						},
						{
							...
							"default":"#0E90D2",
							used:[
								{selector:">.am-active>a,>.am-active>span,>.am-active>a:hover,>.am-active>span:hover,>.am-active>a:focus,>.am-active>span:focus",property:"background-color"},
								{selector:">.am-active>a,>.am-active>span,>.am-active>a:hover,>.am-active>span:hover,>.am-active>a:focus,>.am-active>span:focus",property:"border-color"}
							]
						},
						{
							...
							name:"活动链接文本颜色",
							"default":"#FFF",
							used:[{selector:">.am-active>a,>.am-active>span,>.am-active>a:hover,>.am-active>span:hover,>.am-active>a:focus,>.am-active>span:focus",property:"color"}]
						}
					],
					demos:[
						{
							data:{
								content:{
									...
									page:[
										{title:"1",link:"#"},
										{title:"2",link:"#",className:"am-active"},
										{title:"3",link:"#"},
										{title:"4",link:"#"},
										{title:"5",link:"#"}
									]
					...
					variables:[
						{
							...
							"default":"#EEE",
							used:[
								{selector:">li>a",property:"background-color"},
								{selector:".am-pagination-select select",property:"background-color"}
							]
						},
						{
							variable:"pagination-link-color",
							...
							"default":"#555",
							used:[
								{selector:"> li>a",property:"color"},
								{selector:".am-pagination-select select",property:"color"}
							]
						}
					],
					demos:[
				...
				},
				{
					...
					variables:[
						...
						},
						{
							...
							name:"边框颜色",
							"default":"#DFDFDF",
							used:[{selector:".am-pagination-select select",property:"border-color"}]
						}
					],
					demos:[
						{
		...
		paragraph:{
			id:"paragraph",
			name:"Paragraph",
			localName:{en:"Paragraph","zh-cn":"段落"},
			version:"2.0.1",
			description:"文本段落",
			author:{name:"Shengli",email:"china_victory@yunshipei.com"},
			ver:"2.0",
			...
			themes:[
				{
					...
					demos:[{data:{options:{imgLightbox:!0,tableScrollable:!0}}}]
				},
				{
					name:"one",
					desc:"简约风格",
					...
					variables:[
						...
						},
						{
							...
							used:[
								...
								{selector:"h2",property:"color"},
								{selector:"h3",property:"color"},
								{selector:"h4",property:"color"},
								{selector:"h5",property:"color"},
								{selector:"h6",property:"color"}
							]
						},
						{
						...
						},
						{
							...
							name:"分隔线颜色",
							"default":"#DFDFDF",
							used:[{selector:"hr",property:"background-color"}]
						}
					],
					demos:[{data:{options:{imgLightbox:!0,tableScrollable:!0}}}]
				}
			],
			demoContent:{content:"<img src=assets/i/bing-1.jpg><p class=paragraph-default-p>南极洲又称<a href=http://zh.wikipedia.org/w/index.php?title=%E7%AC%AC%E4%B8%83%E5%A4%A7%E9%99%86&redirect=no>第七大陆</a>，是地球上最后一个被发现、唯一没有土著人居住的大陆。</p><p>南极大陆为通常所说的南大洋（太平洋、印度洋和大西洋的南部水域）所包围，它与南美洲最近的距离为965公里，距新西兰2000公里、距澳大利亚2500公里、距南非3800公里、距中国北京的距离约有12000公里。南极大陆的总面积为1390万平方公里，相当于中国和印巴次大陆面积的总和，居世界各洲第五位。</p><img src=assets/i/bing-2.jpg ><p>整个南极大陆被一个巨大的冰盖所覆盖，平均海拔为2350米。南极洲是由冈瓦纳大陆分离解体而成，是世界上最高的大陆。南极横断山脉将南极大陆分成东西两部分。这两部分在地理和地质上差别很大。</p><img src=assets/i/bing-3.jpg ><p>东南极洲是一块很古老的大陆，据科学家推算,已有几亿年的历史。它的中心位于难接近点，从任何海边到难接近点的距离都很远。东南极洲平均海拔高度2500米，最大高度4800 米。在东南极洲有南极大陆最大的活火山，即位于罗斯岛上的埃里伯斯火山，海拔高度3795米，有四个喷火口</p>"}
		},
		slider:{
			id:"slider",
			name:"Slider",
			localName:{en:"Slider","zh-cn":"图片轮播"},
			version:"3.0.1",
			...
			themes:[
					...
					variables:[
						{
							...
							name:"前后导航按钮颜色",
							"default":"#222",
							used:[{selector:".am-direction-nav a::before",property:"color"}]
						},
						{
							variable:"desc-color",
							name:"描述文字颜色",
							"default":"#FFF",
							used:[{selector:".am-slider-desc",property:"color"}]
						},
						{
							variable:"desc-bg-color",
							name:"描述文字背景颜色",
							"default":"rgba(0,0,0,0.7)",
							used:[{selector:".am-slider-desc",property:"background-color"}]
						},
						{
							variable:"control-nav-bg-color",
							name:"控制点颜色",
							"default":"rgba(0,0,0,0.5)",
							used:[{selector:".am-control-nav li a",property:"background-color"}]
						},
						{
							variable:"control-nav-hover-bg-color",
							name:"控制点Hover颜色",
							"default":"rgba(0,0,0,0.7)",
							used:[{selector:".am-control-nav li a:hover",property:"background-color"}]
						},
						{
							variable:"control-nav-active-bg-color",
							name:"控制点激活颜色",
							"default":"#428BCA",
							used:[{selector:".am-control-nav li a.am-active",property:"background-color"}]
						},
						{
							variable:"pauseplay-color",
							name:"播放暂停按钮颜色",
							"default":"#000",
							used:[{selector:".am-pauseplay a",property:"color"}]
						}
					],
					demos:[
						{desc:"默认",data:{sliderConfig:"{}"}},
						{
							desc:"标题",
							data:{
								sliderConfig:'{"animation":"slide","slideshow":false}',
								content:[
									{img:"assets/i/bing-1.jpg",desc:"这是标题标题标题标题标题标题标题0"},
									{img:"assets/i/bing-2.jpg",desc:"这是标题标题标题标题标题标题标题1"},
									{img:"assets/i/bing-3.jpg",desc:"这是标题标题标题标题标题标题标题2"},
									{img:"assets/i/bing-4.jpg",desc:"这是标题标题标题标题标题标题标题3"}
								]
							}
						},
						{
							...
							data:{
								...
								content:[
									...
									{img:"assets/i/bing-4.jpg"},
									{img:"assets/i/bing-1.jpg"},
									{img:"assets/i/bing-2.jpg",thumb:"assets/i/bing-2.jpg"},
									{img:"assets/i/bing-3.jpg"},
									{img:"assets/i/bing-4.jpg"}
								]
							}
						},
						{
							...
							data:{
								...
								content:[
									{thumb:"assets/i/bing-1.jpg",img:"assets/i/bing-1.jpg"},
									{thumb:"assets/i/bing-2.jpg",img:"assets/i/bing-2.jpg"},
									{thumb:"assets/i/bing-3.jpg",img:"assets/i/bing-3.jpg"},
									{thumb:"assets/i/bing-4.jpg",img:"assets/i/bing-4.jpg"}
								]
							}
						}
					]
				},
				{
					name:"a1",
					desc:"圆形控制点",
					options:{animation:"slide",initDelay:0,itemWidth:0},
					...
					demos:[{desc:"",data:{sliderConfig:'{"directionNav":false}'}}]
				},
				{
					name:"a2",
					desc:"方形控制点",
					...
					demos:[{data:{sliderConfig:'{"directionNav":false}'}}]
				},
				{
					name:"a3",
					desc:"底部黑边圆形控制点",
					...
					variables:[
						{
							...
							name:"控制点背景色",
							"default":"#000",
							used:[{selector:".am-control-nav",property:"background-color"}]
						},
						{
							variable:"control-nav-bg-color",
							name:"控制点颜色",
					...
					variables:[
						{
							...
							name:"箭头颜色",
							"default":"#333",
							used:[{selector:".am-direction-nav a",property:"color"}]
						},
						{
							variable:"direction-nav-bg-color",
							name:"箭头背景色",
							"default":"rgba(0,0,0,0.5)",
							used:[{selector:".am-direction-nav a",property:"background-color"}]
						}
					],
					demos:[{data:{sliderConfig:'{"controlNav":false}'}}]
				},
				{
					name:"b2",
					desc:"圆形居中左右箭头",
					...
					demos:[
						{
							data:{
								...
								content:[
									{img:"assets/i/bing-1.jpg",desc:"远方 有一个地方 那里种有我们的梦想"},
									{img:"assets/i/bing-2.jpg",desc:"某天 也许会相遇 相遇在这个好地方"},
									{img:"assets/i/bing-3.jpg",desc:"不要太担心 只因为我相信 终会走过这条遥远的道路"},
									{img:"assets/i/bing-4.jpg",desc:"OH PARA PARADISE 是否那么重要 你是否那么地遥远"}
								]
							}
						}
					]
				...
				},
				{
					...
					variables:[
						...
						},
						{
							...
							used:[{selector:".am-slider-counter",property:"background-color"}]
						},
						{
							variable:"counter-color",
							name:"计数颜色",
							"default":"#EEE",
							used:[{selector:".am-slider-counter",property:"color"}]
						},
						{
							variable:"counter-active-color",
							name:"计数激活颜色",
							"default":"rgba(255,0,0,0.7)",
							used:[{selector:".am-slider-counter .am-active",property:"color"}]
						}
					],
					demos:[
						{
							data:{
								sliderConfig:'{"controlNav":false}',
								content:[
									{img:"assets/i/bing-1.jpg",desc:'<div class="am-slider-counter"><span class="am-active">1</span>/4</div>远方 有一个地方 那里种有我们的梦想'},
									{img:"assets/i/bing-2.jpg",desc:'<div class="am-slider-counter"><span class="am-active">2</span>/4</div>某天 也许会相遇 相遇在这个好地方'},
									{img:"assets/i/bing-3.jpg",desc:'<div class="am-slider-counter"><span class="am-active">3</span>/4</div>不要太担心 只因为我相信 终会走过这条遥远的道路'},
									{img:"assets/i/bing-4.jpg",desc:'<div class="am-slider-counter"><span class="am-active">4</span>/4</div>OH PARA PARADISE 是否那么重要 你是否那么地遥远'}
								]
							}
						}
					]
				...
				},
				{
					...
					variables:[
						...
						},
						{
							...
							name:"更多链接颜色",
							"default":"#EEE",
							used:[{selector:".am-slider-more",property:"color"}]
						},
						{
							variable:"direction-nav-color",
							name:"箭头颜色",
							...
							used:[
								{selector:".am-direction-nav a",property:"border-color"},
								{selector:".am-direction-nav a",property:"color"}
							]
						}
					],
					demos:[
						{
							data:{
								sliderConfig:'{"controlNav":false}',
								content:[
									{img:"assets/i/bing-1.jpg",desc:'<h2 class="am-slider-title">远方 有一个地方 那里种有我们的梦想</h2><a class="am-slider-more">了解更多</a>'},
									{img:"assets/i/bing-2.jpg",desc:'<h2 class="am-slider-title">某天 也许会相遇 相遇在这个好地方</h2><a class="am-slider-more">了解更多</a>'},
									{img:"assets/i/bing-3.jpg",desc:'<h2 class="am-slider-title">不要太担心 只因为我相信 终会走过这条遥远的道路</h2><a class="am-slider-more">了解更多</a>'},
									{img:"assets/i/bing-4.jpg",desc:'<h2 class="am-slider-title">OH PARA PARADISE 是否那么重要 你是否那么地遥远</h2><a class="am-slider-more">了解更多</a>'}
								]
							}
						}
					]
				},
				{
					...
					variables:[
						...
						},
						{
							...
							name:"描述文字背景颜色",
							"default":"rgba(0,0,0,0.7)",
							used:[{selector:".am-slider-content",property:"background-color"}]
						},
						{
							variable:"more-color",
							name:"更多链接颜色",
						...
						},
						{
							...
							name:"更多背景颜色",
							"default":"#F26422",
							used:[{selector:".am-slider-more",property:"background-color"}]
						},
						{
							variable:"control-nav-bg-color",
							name:"控制点颜色",
					...
					demos:[
						{
							data:{
								sliderConfig:'{"directionNav":false}',
								content:[
									{img:"assets/i/bing-1.jpg",desc:'<div class="am-slider-content"><h2 class="am-slider-title">远方 有一个地方 那里种有我们的梦想</h2><p>内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内</p></div><a class="am-slider-more">了解更多</a>'},
									{img:"assets/i/bing-2.jpg",desc:'<div class="am-slider-content"><h2 class="am-slider-title">某天 也许会相遇 相遇在这个好地方</h2><p>内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内</p></div><a class="am-slider-more">了解更多</a>'},
									{img:"assets/i/bing-3.jpg",desc:'<div class="am-slider-content"><h2 class="am-slider-title">不要太担心 只因为我相信 终会走过这条遥远的道路</h2><p>内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内</p></div><a class="am-slider-more">了解更多</a>'},
									{img:"assets/i/bing-4.jpg",desc:'<div class="am-slider-content"><h2 class="am-slider-title">OH PARA PARADISE 是否那么重要 你是否那么地遥远</h2><p>内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内</p></div><a class="am-slider-more">了解更多</a>'}
								]
							}
						}
					]
				},
				{
					...
					variables:[
						...
						},
						{
							...
							"default":"rgba(0,0,0,0.7)",
							used:[
								{selector:".am-slider-desc",property:"background-color"},
								{selector:".am-control-thumbs .am-active + i",property:"border-top-color"}
							]
						}
					],
					demos:[
					...
					variables:[
						{
							...
							name:"描述文字颜色",
							"default":"#FFF",
							used:[{selector:".am-viewport .am-slider-desc",property:"color"}]
						},
						{
							variable:"slider-dese-bg",
							name:"描述文字背景颜色",
							"default":"rgba(0,0,0,0.5)",
							used:[{selector:".am-viewport .am-slider-desc",property:"background-color"}]
						}
					],
					demos:[
						{
							...
							data:{
								sliderConfig:'{"directionNav":false}',
								content:[
									{img:"assets/i/bing-1.jpg",desc:'<h2 class="am-slider-title">远方 有一个地方 那里种有我们的梦想</h2>'},
									{img:"assets/i/bing-2.jpg",desc:'<h2 class="am-slider-title">某天 也许会相遇 相遇在这个好地方</h2>'},
									{img:"assets/i/bing-3.jpg",desc:'<h2 class="am-slider-title">不要太担心 只因为我相信 终会走过这条遥远的道路</h2>'},
									{img:"assets/i/bing-4.jpg",desc:'<h2 class="am-slider-title">OH PARA PARADISE 是否那么重要 你是否那么地遥远</h2>'}
								]
							}
						}
					]
					...
					variables:[
						{
							...
							name:"标签背景色",
							"default":"#EEE",
							used:[{selector:".am-tabs-nav",property:"background-color"}]
						},
						{
							variable:"tabs-nav-color",
							name:"标签颜色",
							"default":"#333",
							used:[{selector:".am-tabs-nav a",property:"color"}]
						},
						{
							variable:"tabs-nav-active-bg",
							name:"激活标签背景色",
							"default":"#0E90D2",
							used:[{selector:".am-tabs-nav>.am-active a",property:"background-color"}]
						},
						{
							variable:"tabs-nav-active-color",
							name:"激活标签颜色",
							"default":"#FFF",
							used:[{selector:".am-tabs-nav>.am-active a",property:"color"}]
						}
					],
					demos:[{data:{options:{cols:"3"}}}]
				},
				{
					name:"d2",
					desc:"下边框选项卡",
					...
					variables:[
						...
						},
						{
							...
							"default":"#FFF",
							used:[
								{selector:".am-tabs-nav>.am-active a",property:"color"},
								{selector:".am-tabs-nav>.am-active",property:"border-bottom-color"},
								{selector:".am-tabs-nav>.am-active:after",property:"border-bottom-color"}
							]
						}
					],
					demos:[{data:{options:{cols:"3"}}}]
				},
				{
					...
					variables:[
						...
						},
						{
							...
							name:"标签边框颜色",
							"default":"#15AFEF",
							used:[{selector:".am-tabs-nav,.am-tabs-nav>li + li",property:"border-color"}]
						},
						{
							variable:"tabs-nav-color",
							name:"标签颜色",
		...
		titlebar:{
			id:"titlebar",
			name:"Titlebar",
			localName:{en:"Titlebar","zh-cn":"标题栏"},
			version:"4.0.1",
			...
			themes:[
				{
					...
					variables:[
						...
						},
						{
							...
							name:"文本颜色",
							"default":"#0E90D2",
							used:[{selector:".am-titlebar-title",property:"color"}]
						},
						{
						...
						},
						{
							...
							name:"下边框颜色",
							"default":"#DEDEDE",
							used:[{selector:"",property:"border-bottom-color"}]
						},
						{
							variable:"titlebar-border-left-color",
							name:"左边框颜色",
							"default":"#0E90D2",
							used:[{selector:".am-titlebar-title:before",property:"border-left-color"}]
						}
					],
					demos:[
						{
							...
							data:{
								content:{
									title:"栏目标题",
									nav:[{title:"more &raquo;",link:"#more"}]
								}
							}
						},
						{
				...
				},
				{
					...
					variables:[
						...
						},
						{
							...
							name:"上边框颜色",
							"default":"#3bb4f2",
							used:[{selector:"",property:"border-top-color"}]
						},
						{
						...
						},
						{
							...
							data:{
								content:{
									title:"科技频道",
									nav:[
										{title:"手机",link:"#more-1"},
										{title:"数码",link:"#more-2"},
										{title:"影音",link:"#more-3"}
									]
								}
							}
						}
				...
				},
				{
					...
					variables:[
						...
						},
						{
							...
							"default":"#0E90D2",
							used:[
								{selector:".am-titlebar-title,.am-titlebar-title a",property:"color"},
								{selector:".am-titlebar-title",property:"border-bottom-color"}
							]
						}
					],
					demos:[
				...
				},
				{
					...
					variables:[
						...
						},
						{
							...
							"default":"#15AFEF",
							used:[
								{selector:"",property:"border-bottom-color"},
								{selector:".am-titlebar-title:before",property:"border-left-color"}
							]
						},
						{
						...
						},
						{
							...
							name:"标题链接颜色",
							"default":"#222",
							used:[{selector:".am-titlebar-title a",property:"color"}]
						},
						{
							variable:"titlebar-nav-link-color",
							name:"更多链接颜色",
							"default":"#999",
							used:[{selector:".am-titlebar-nav,.am-titlebar-nav a",property:"color"}]
						}
					],
					demos:[
						{
		...
		wechatpay:{
			id:"wechatpay",
			name:"WeChat Pay",
			localName:{en:"WeChat Pay","zh-cn":"微信支付"},
			version:"1.0.0",
			description:"微信支付",
			author:{name:"hzp",email:"hzp@yunshipei.com"},
			ver:"1.0",
...
var listTags=["accordion","divider","duoshuo","figure","footer","gallery","gotop","header","intro","list_news","map","mechat","menu","navbar","pagination","paragraph","slider","tabs","titlebar","wechatpay"];
var listCache={};
function getData(k,v){
	...
	$.each(v,function(k1,v1){
		if(v1.name.indexOf("one")>-1||v1.deprecated||v1.demos.length){
			$.each(v1.demos,function(k2,v2){
				r.push({demoName:v1.name+"("+(v2.desc||v1.desc)+")",demoURL:"docs/widget/"+k+"_"+v1.name+"_"+k2+".jsp"});
			});
		}
	});
	listCache[k]=r;
...
!function(e){
	...
	var Scroll=e.AMUI.iScroll;
	if(Scroll){
		var o=function(){
			var body=e("body");
			var widget=e("#widget-list");
			var demoTitle=e(".widget-hd").find("h1");
			var demoList=e("#demo-scroller");
			this.demoCache={};
			...
			this.setActive=function(k,ds){
				if(!this.demoCache[k]){
					this.demoCache[k]=this.compile(ds);
				}
				demoList.empty().html(this.demoCache[k]);
				body.addClass("demo-list-active");
				if(!this.demoScroll){
					this.demoScroll=new Scroll("#demo-list",{tap:!0});
				}
				window.setTimeout(e.proxy(function(){
					this.demoScroll.refresh();
				},this),100);
			};
			this.createList=function(k){
				k=k||window.location.hash.replace("#","");
				if(k){
					demoTitle.text(widget.find("[data-rel="+k+"]").text()+" Demos");
				}
				!k||listTags.indexOf(k)<0?this.resetActive():this.setActive(k,getData(k,_widgets[k].themes));
			};
			this.init=function(){
				widget.on("click tap","a",function(a){
					a.preventDefault();
				...
				e("#btn-back").on("click",function(e){
					e.preventDefault();
					window.location.hash="";
				});
				widget.on("touchmove",function(e){
					e.preventDefault();
				});
				this.createList();
				new Scroll(widget[0]);
