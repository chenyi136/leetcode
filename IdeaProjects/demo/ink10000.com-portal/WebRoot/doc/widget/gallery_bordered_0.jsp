...
<head>
	<title>图片画廊 - bordered（容器边框）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<div data-backend-compiled id="demo-view">
		<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 am-gallery am-gallery-bordered" data-am-widget="gallery" data-am-gallery="{pureview:true}">
			<li>
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/gallery_overlay_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/gallery_imgbordered_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="5c14dbc0197220d1464d7c129c82189f" data-title="图片画廊 - bordered（容器边框）|Amaze UI" id="ds-thread"></div>
</div>
