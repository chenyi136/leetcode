...
<head>
	<title>选项卡 - one（简约风格）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<div data-backend-compiled id="demo-view">
		<div class="am-tabs am-tabs-one" data-am-widget="tabs">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/tabs_d2_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/titlebar_default_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="1130b7c052bbfc6f4b6602281da15339" data-title="选项卡 - one（简约风格）|Amaze UI" id="ds-thread"></div>
</div>
