...
<head>
	<title>内容列表 - default（默认） - 右图+摘要|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/list_news_default_4.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/list_news_default_6.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="1d0a8930d65b356b53b8c6c652b9f215" data-title="内容列表 - default（默认） - 右图+摘要|Amaze UI" id="ds-thread"></div>
</div>
