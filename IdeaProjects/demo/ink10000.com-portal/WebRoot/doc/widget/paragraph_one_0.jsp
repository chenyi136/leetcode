...
<head>
	<title>段落 - one（简约风格）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<div data-backend-compiled id="demo-view">
		<article class="am-paragraph am-paragraph-one" data-am-widget="paragraph" data-am-paragraph="{tableScrollable:true,pureview:true}">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/paragraph_default_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/slider_default_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="5a8f32c5c880d74f20988fe5b144374f" data-title="段落 - one（简约风格）|Amaze UI" id="ds-thread"></div>
</div>
