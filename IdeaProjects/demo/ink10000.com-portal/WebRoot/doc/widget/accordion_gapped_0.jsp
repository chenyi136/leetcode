...
<head>
	<title>折叠面板 - gapped（扁平分离边框）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/accordion_basic_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/accordion_one_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="3abe8e329cf900a2b029af8df4dcb00c" data-title="折叠面板 - gapped（扁平分离边框）|Amaze UI" id="ds-thread"></div>
</div>
