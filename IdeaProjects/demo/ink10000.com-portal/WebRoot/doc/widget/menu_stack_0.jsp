...
<head>
	<title>菜单 - stack（垂直菜单）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/menu_offcanvas2_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/menu_one_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="c10711adb4033fc3b257ff89b8c75b63" data-title="菜单 - stack（垂直菜单）|Amaze UI" id="ds-thread"></div>
</div>
