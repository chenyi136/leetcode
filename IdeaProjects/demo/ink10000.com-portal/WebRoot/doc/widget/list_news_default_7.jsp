...
<head>
	<title>内容列表 - default（默认） - 下右图+摘要|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/list_news_default_6.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/list_news_one_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="3f1e9e7f74ce52307e1bbb790b696c78" data-title="内容列表 - default（默认） - 下右图+摘要|Amaze UI" id="ds-thread"></div>
</div>
