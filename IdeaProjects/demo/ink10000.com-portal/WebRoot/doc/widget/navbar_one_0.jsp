...
<head>
	<title>工具栏 - one（简约风格）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<div data-backend-compiled id="demo-view">
		<div class="am-navbar am-navbar-one am-cf" data-am-widget="navbar">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/navbar_default_1.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/pagination_default_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="f30da50862241ac7a3061785a495a704" data-title="工具栏 - one（简约风格）|Amaze UI" id="ds-thread"></div>
</div>
