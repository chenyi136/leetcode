...
<head>
	<title>图片画廊 - one（简约风格）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<div data-backend-compiled id="demo-view">
		<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 am-gallery am-gallery-one" data-am-widget="gallery" data-am-gallery="{pureview:true}">
			<li>
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/gallery_imgbordered_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/gotop_default_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="d96b132993d23cb62269bea8a8f61627" data-title="图片画廊 - one（简约风格）|Amaze UI" id="ds-thread"></div>
</div>
