...
<head>
	<title>图片画廊 - imgbordered（图片边框）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<div data-backend-compiled id="demo-view">
		<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 am-gallery am-gallery-imgbordered" data-am-widget="gallery" data-am-gallery="{pureview:true}">
			<li>
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/gallery_bordered_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/gallery_one_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="bb09e4b654b537e8c35cfe2179e2d5d0" data-title="图片画廊 - imgbordered（图片边框）|Amaze UI" id="ds-thread"></div>
</div>
