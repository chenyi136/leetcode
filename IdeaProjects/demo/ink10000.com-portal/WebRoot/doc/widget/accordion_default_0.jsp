...
<head>
	<title>折叠面板 - default（圆角灰边）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev am-disabled"><a href="doc/widget/index_m.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/accordion_basic_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="c9002b4e970a26751f0ea38bc4782fac" data-title="折叠面板 - default（圆角灰边）|Amaze UI" id="ds-thread"></div>
</div>
