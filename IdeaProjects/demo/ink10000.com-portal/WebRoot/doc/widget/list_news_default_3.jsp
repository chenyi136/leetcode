...
<head>
	<title>内容列表 - default（默认） - 上图+摘要|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/list_news_default_2.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/list_news_default_4.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="fa81d4a41bd849e7add115870e81513b" data-title="内容列表 - default（默认） - 上图+摘要|Amaze UI" id="ds-thread"></div>
</div>
