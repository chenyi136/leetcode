...
<head>
	<title>图片轮播 - default（默认） - 默认|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/paragraph_one_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/slider_default_1.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="5c4a24b1fe03105d855bce6e6c789dcc" data-title="图片轮播 - default（默认） - 默认|Amaze UI" id="ds-thread"></div>
</div>
