...
<head>
	<title>菜单 - default（横排） - 横排|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/mechat_default_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/menu_dropdown1_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="4eccb69fb4bbe3b9e0c6b56da0ce0f13" data-title="菜单 - default（横排） - 横排|Amaze UI" id="ds-thread"></div>
</div>
