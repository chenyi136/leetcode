...
<head>
	<title>图片画廊 - overlay（浮层标题）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/gallery_default_1.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/gallery_bordered_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="836cae7fab8e5d603ef9bac5d9886b7c" data-title="图片画廊 - overlay（浮层标题）|Amaze UI" id="ds-thread"></div>
</div>
