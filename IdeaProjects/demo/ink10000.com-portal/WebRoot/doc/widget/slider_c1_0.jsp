...
<head>
	<title>图片轮播 - c1（标题+长条控制点）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/slider_b4_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/slider_c2_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="4adfd56edef43d0b0add4f0ddea2a279" data-title="图片轮播 - c1（标题+长条控制点）|Amaze UI" id="ds-thread"></div>
</div>
