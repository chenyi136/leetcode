...
<head>
	<title>图片轮播 - b2（圆形居中左右箭头）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/slider_b1_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/slider_b3_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="01e181fbc5426200fca1213dd1987fe5" data-title="图片轮播 - b2（圆形居中左右箭头）|Amaze UI" id="ds-thread"></div>
</div>
