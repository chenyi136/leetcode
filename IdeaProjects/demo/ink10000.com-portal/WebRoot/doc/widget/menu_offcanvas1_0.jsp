...
<head>
	<title>菜单 - offcanvas1（侧滑竖排） - 侧滑左侧|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/menu_slide1_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/menu_offcanvas1_1.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="cec96102ccc2ee3cfd651ecaf1c5dfab" data-title="菜单 - offcanvas1（侧滑竖排） - 侧滑左侧|Amaze UI" id="ds-thread"></div>
</div>
