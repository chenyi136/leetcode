...
<head>
	<title>内容列表 - one（简约风格） - 带摘要|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/list_news_one_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/list_news_one_2.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="8d8e4714caa837e3338faa1d6bacfc37" data-title="内容列表 - one（简约风格） - 带摘要|Amaze UI" id="ds-thread"></div>
</div>
