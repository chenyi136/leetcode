...
<head>
	<title>菜单 - dropdown1（下拉全宽） - 自定图标|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/menu_default_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/menu_dropdown1_1.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="b07b20fea408357ecc6aa66793058792" data-title="菜单 - dropdown1（下拉全宽） - 自定图标|Amaze UI" id="ds-thread"></div>
</div>
