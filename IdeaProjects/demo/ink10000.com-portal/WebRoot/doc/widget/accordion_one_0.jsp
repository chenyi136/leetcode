...
<head>
	<title>折叠面板 - one（简约风格）|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<div data-backend-compiled id="demo-view">
		<section class="am-accordion am-accordion-one" data-am-widget="accordion" data-am-accordion>
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/accordion_gapped_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/divider_default_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="7cff42275ff6c924e9ec6f69d59b7314" data-title="折叠面板 - one（简约风格）|Amaze UI" id="ds-thread"></div>
</div>
