...
<head>
	<title>内容列表 - default（默认） - 左图+摘要|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/list_news_default_3.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/list_news_default_5.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="40cc56398a0cbb3f9b2a247438866941" data-title="内容列表 - default（默认） - 左图+摘要|Amaze UI" id="ds-thread"></div>
</div>
