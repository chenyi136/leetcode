...
<head>
	<title>内容列表 - one（简约风格） - 带缩略图+摘要|Amaze UI</title>
...
<div class="page pg-demo">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/list_news_one_1.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/map_default_0.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="55de9a155699df90619244e4dabb8681" data-title="内容列表 - one（简约风格） - 带缩略图+摘要|Amaze UI" id="ds-thread"></div>
</div>
