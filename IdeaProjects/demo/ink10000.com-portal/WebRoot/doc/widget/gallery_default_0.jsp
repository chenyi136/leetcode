...
<head>
	<title>图片画廊 - default（无边框） - 2列|Amaze UI</title>
...
<div class="page pg-demo">
			...
			<li>
				<div class="am-gallery-item">
					<a href="doc/image/bing-1.jpg">
						<ins>
							<img src="doc/image/bing-1.jpg" alt="远方有一个地方那里种有我们的梦想">
	...
	<ul class="am-pagination">
		<li class="am-pagination-prev"><a href="doc/widget/footer_one_0.jsp">&laquo; Prev</a></li>
		<li class="am-pagination-next"><a href="doc/widget/gallery_default_1.jsp">Next &raquo;</a></li>
	</ul>
	<div class="ds-thread" data-thread-key="5831326bc54184f76ef2f2e0ce1cc277" data-title="图片画廊 - default（无边框） - 2列|Amaze UI" id="ds-thread"></div>
</div>
