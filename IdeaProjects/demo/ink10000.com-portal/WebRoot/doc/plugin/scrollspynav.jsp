...
<head>
	<title>JS 插件 - Scrollspynav|Amaze UI</title>
		...
		<div class="am-u-md-9 col-md-9 doc-content">
					...
					<ul class="md-toc">
						...
						<li>
							...
							<ul class="am-collapse">
								...
								<li><a href="#xuan-xiang-shuo-ming">选项说明</a></li>
							</ul>
						</li>
					</ul>
				</div>
			</div>
			<h1 id="scrollspynav">ScrollSpyNav <a href="#scrollspynav" class="doc-anchor"></a></h1>
			<hr>
			<p>适用于页面内导航，窗口滚动时，锚点对应的链接添加高亮样式类（<code>.am-active</code>）。</p>
			...
			<div class="doc-example">
				...
				<div class="am-panel am-panel-default" id="second">
					...
					<div class="am-panel-bd"><p>来自街头的声音。飘浮在城市天空的“棉花糖”。 柔软却刚强，义无反顾地行进。 棉花糖[katncandix2] 小球+圣哲 第2张全创作专辑 [再见王子] 再见梦想。再见初恋。再见泪水。再见昨天。 必须向天真的自己说再见，才能勇敢地冒险找到未来。 幻灭之后的蜕变，是重生的那一刻。 “小飞行”好评后 严选《再见王子》《好日子》《怎么说呢?》《回不去的旅人》 全新格局 10篇刻印成长的青春创作 词+曲+创作+制作+演唱 棉花糖 棉花糖的音乐形成自成一格的清透感 。</p></div>
				</div>
				<div class="am-panel am-panel-default" id="third">
					<div class="am-panel-hd">第三张</div>
					<div class="am-panel-bd">
						<p>一切看似美好的过程之中，有许多不同却深刻的故事，跟随着生命和宇宙的运行发生中。悲伤的、快乐的时常已无以名状。棉花糖将过程中产生的讯息，刻划成专辑里的十一首歌曲。棉花糖此时还能笑着说这张专辑：「我们走进了黑暗的入口，开始寻找希望与光明，当真正找到了透进光线的出口并走出时，我们早已伤痕无数、甚至被种植黑暗，热情是唯一能抵抗的道具。」我说，那是一段不被了解的路程。</p>
			...
			<p>添加 <code>data-am-scrollspy-nav</code> 属性，并设置相关选项。</p>
			<h3 id="js-diao-yong">JS 调用 <a href="#js-diao-yong" class="doc-anchor"></a></h3>
			<p>通过 <code>$().scrollspynav(options)</code> 调用。</p>
			<h3 id="xuan-xiang-shuo-ming">选项说明 <a href="#xuan-xiang-shuo-ming" class="doc-anchor"></a></h3>
			...
			<p>通过 Data API 设置时，代码为 <code>data-am-scrollspy-nav='{className:{active:&#39;am-active&#39;}}'</code>。</p>
			<div class="ds-thread" data-thread-key="e6d1dcf48f69b0066d8dc391c1b75f8a" data-title="JS 插件 - Scrollspynav|Amaze UI" id="ds-thread"></div>
		</div>
	</div>
</section>
