<%@ page language="java" import="com.mc.core.entity.auto.Work" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
<div class="am-cf" id="j_hold">
	...
	<div id="j_right">
		<%=crumb(request)%>
		<div class="am-g">
		<div class="am-u-md-12 am-margin-bottom-xs am-padding-0">
			<a class="am-btn am-btn-secondary <%=icon("save")%>" onclick="save(this)"> 保存配置(<%=JsonTool.read(pages.getLibrary(), String[].class).length%>)</a>
		</div>
...
function save(o){
	...
	$.ajax({
		type:"post",
		url:"${ROOT}auto/work/library.htm",
		data:{id:<%=pages.getId()%>,keys:keys},
		dataType:"json",
		async:false,
