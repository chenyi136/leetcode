(function(){
	var title=$G("J_title"),titleCol=$G("J_titleCol"),caption=$G("J_caption"),sorttable=$G("J_sorttable"),autoSizeContent=$G("J_autoSizeContent"),autoSizePage=$G("J_autoSizePage"),tone=$G("J_tone"),me=null,preview=$G("J_preview");
	...
	editTable.prototype={
		...
		autoSizeContentHanler:function(){
			$G("J_example").removeAttribute("width");
		},
		autoSizePageHanler:function(){
			var example=$G("J_example");
			utils.each(example.getElementsByTagName(example,"td"),function(td){
		...
		updateSortSpan:function(){
			...
			utils.each(domUtils.getElementsByTagName(example,"span"),function(span){
		...
		getColor:function(){
			var cell=domUtils.findParentByTagName(editor.selection.getStart(),["td","th","caption"],true);
			var color=cell&&domUtils.getComputedStyle(cell,"border-color");
