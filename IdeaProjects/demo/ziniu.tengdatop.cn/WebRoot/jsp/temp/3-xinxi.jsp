...
<head>
	...
	<link rel="stylesheet" type="text/css" href="comm/css/ui-dialog.css">
<style type="text/css">
							...
							<div class="blog_info_box">
								<div class="row" style="min-height: 350px;">
									<div class="col-md-4">
										<div class="datum_box">
											<div class="photo">
												<a href="javascript:App.dialogById('上传头像','dialog-a');"><img src="comm/images/photo2.png"></a>
									...
									<div class="col-md-4">
										<div class="versions_box">
											...
											<div style="margin-right:30px;" class="member">
												<img src="comm/images/versions_box_icon1.png" class="vm">
											...
											<div style="display:none;" class="ensconce_box">
												<form>
													...
													<p class="pb10">
														...
														<img src="comm/images/code.png" style="width:100px;height:40px" class="ml10 vm">
					...
					<div class="col-md-2">
						<div class="information_wrap">
							<div class="private_messages">
								<div class="title">
									<img src="comm/images/private_messages_icon1.png" class="ml10">
									<span class="ml5">站内信息</span>
								</div>
								<dl>
									<dd><a href="#">【曝光】长沙长江医院怎么样?员工揭内幕...</a></dd>
									<dd><a href="#">【曝光】长沙长江医院怎么样?员工揭内幕...</a></dd>
									<dd><a href="#">【曝光】长沙长江医院怎么样?员工揭内幕...</a></dd>
									<dd><a href="#">【曝光】长沙长江医院怎么样?员工揭内幕...</a></dd>
									<dd><a href="#">【曝光】长沙长江医院怎么样?员工揭内幕...</a></dd>
...
<div style="display:none;" id="dialog-a">
	<p class="ta-c pb10"><img src="comm/images/photo2.png" style="width:150px;height:150px;border-radius:50%;"></p>
...
<script type="text/javascript" src="comm/js/dialog.js"></script>
<script type="text/javascript" src="comm/js/dialog-min.js"></script>
